...
const HighestWinningPercentageTeammateCard = ({ playerName,winningPercentage }) => (
    <StyledCard>
        <CardContent>
            ...
            {playerName && (
                <WinningPercentageTypography variant="body1" component="div">
                    Won {winningPercentage}% of games together
...
export default HighestWinningPercentageTeammateCard;
